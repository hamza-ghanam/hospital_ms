...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <h4 class="card-header">تعديل رسالة شكر</h4>
                    <div class="card-body">
                        <form method="POST" action="{{URL::to("/thank_msgs/$thankMsg->id")}}">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <textarea maxlength="350" rows="6" cols="70" name="body" required="required" id="body" class="form-control">{{$thankMsg->body}}</textarea>
                                </div>
                            </div>
                            <br/>
                            <div class="col-sm-8">
